...
class SphinxClient:
    ...
    def SetSortMode(self, mode, clause=''):
        ...
        """
        assert (
            mode in [SPH_SORT_RELEVANCE, SPH_SORT_ATTR_DESC, SPH_SORT_ATTR_ASC, SPH_SORT_TIME_SEGMENTS,
                     SPH_SORT_EXTENDED,
                     SPH_SORT_EXPR])
    ...
    def SetQueryFlag(self, name, value):
        ...
        flags = {"reverse_scan": [0, 1], "sort_method": ["pq", "kbuffer"], "max_predicted_time": [0],
                 ...
                 "idf": ["normalized", "plain", "tfidf_normalized", "tfidf_unnormalized"], "global_idf": [True, False]}
    ...
    def AddQuery(self, query, index='*', comment=''):
        ...
        # token_filter
        req.append(pack('>L', len(self._tokenfilterlibrary)) + self._tokenfilterlibrary.encode())
        req.append(pack('>L', len(self._tokenfiltername)) + self._tokenfiltername.encode())
        req.append(pack('>L', len(self._tokenfilteropts)) + self._tokenfilteropts.encode())
